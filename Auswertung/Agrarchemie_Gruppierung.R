...
getwd()
setwd("/Users/jonas/Documents/Promotion/Datenauswertung/Daten/Agrarchemie")
...
df_combined <- read.csv2("Agrarchemie_Auswertung.csv", row.names = 1)
...
write.csv2(df_number, file = "Agrarchemie_Beteiligungsmuster_Anzahl.csv")
write.csv2(df_size, file = "Agrarchemie_Beteiligungsmuster_Fondsvolumen.csv")
...
sum(df_size$`Summiertes Fondsvolumen (in Mio. Euro)`)
sum(df_size$`Anzahl Fonds`)
